...
<div
	class="absolute z-30 w-24 h-24 -translate-x-1/2 translate-y-1/2 cursor-pointer opacity-60 left-1/2 bottom-1/2"
	on:click={() => dispatcher('click')}
>
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="#fefefe">
		<switch>
			<g>
				<path
